                ...
                <div>
                    <div className="brands">
                        ...
                        <div className="brands__content" ref={brands}>
                            ...
                            <img src="/img/logos/logo-partner-ys.svg" alt="brand" className="brand__logo mobile_logo1 desktop_logo1" />
                            <img src="/img/logos/logo-partner-abel.svg" alt="brand" className="brand__logo mobile_logo2 desktop_logo1" />
                            <img src="/img/logos/logo-partner-yr.svg" alt="brand" className="brand__logo mobile_logo2 desktop_logo1" />
                            ...
                            <img src="/img/logos/logo-partner-abel.svg" alt="brand" className="brand__logo mobile_logo2 desktop_logo1" />
                            <img src="/img/logos/logo-partner-yr.svg" alt="brand" className="brand__logo mobile_logo2 desktop_logo1" />
                            <img src="/img/logos/logo-partner-true.svg" alt="brand" className="brand__logo mobile_logo2 desktop_logo2" />
                            <img src="/img/logos/logo-partner-saatchi.svg" alt="brand" className="brand__logo mobile_logo3 desktop_logo2" />
                            <img src="/img/logos/logo-partner-ys.svg" alt="brand" className="brand__logo mobile_logo3 desktop_logo2" />
                            <img src="/img/logos/logo-partner-abel.svg" alt="brand" className="brand__logo mobile_logo3 desktop_logo2" />
                            <img src="/img/logos/logo-partner-yr.svg" alt="brand" className="brand__logo mobile_logo4 desktop_logo2" />
                            <img src="/img/logos/logo-partner-true.svg" alt="brand" className="brand__logo mobile_logo4 desktop_logo3" />
                            <img src="/img/logos/logo-partner-saatchi.svg" alt="brand" className="brand__logo mobile_logo4 desktop_logo3" />
                            <img src="/img/logos/logo-partner-ys.svg" alt="brand" className="brand__logo mobile_logo5 desktop_logo3" />
                            <img src="/img/logos/logo-partner-abel.svg" alt="brand" className="brand__logo mobile_logo5 desktop_logo3" />
                            <img src="/img/logos/logo-partner-yr.svg" alt="brand" className="brand__logo mobile_logo5 desktop_logo3" /> */}
